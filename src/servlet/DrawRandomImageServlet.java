...
@WebServlet(name = "DrawRandomImageServlet",urlPatterns = {"/drawImage"})
public class DrawRandomImageServlet extends HttpServlet {
    ...
    public static final int CODE_LENGTH = 4;//字符串的个数
