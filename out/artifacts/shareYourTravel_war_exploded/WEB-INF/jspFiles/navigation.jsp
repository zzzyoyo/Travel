                        ...
                        <c:when test='<%=user!=null%>'>
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="${pageContext.request.contextPath}/friends.jsp"><span class="glyphicon glyphicon-heart-empty" aria-hidden="true"></span>我的好友<span class="badge">42</span></a></li>
