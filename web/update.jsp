...
<div style="width: 30%;margin: auto">
    ...
    <form>
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInputTtile" placeholder="Title">
        </div>
        <div class="form-group">
            <label for="exampleInputTheme">主题</label>
            <input type="text" class="form-control" id="exampleInputTheme" placeholder="Theme">
        </div>
        <div class="form-group">
            <label for="exampleInputDescription">简介</label>
            <textarea class="form-control" id="exampleInputDescription" placeholder="Description" rows="3"></textarea>
        </div>
        <div class="form-group">
